      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center py-4 md:justify-start md:space-x-10">
          ...
          <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0 space-x-4">
            <Link href="/cart" className="flex items-center" prefetch={true} shallow={true}>
              <Button variant="default" className="flex items-center hover:text-white hover:bg-bandiwala-red">
                <ShoppingBag className="h-5 w-5 mr-2" />
                Cart
              </Button>
            </Link>
            
            {!isLoggedIn?<div className="flex flex-row space-x-2">
            <Link href='/login' prefetch={true}>
              <Button variant="outline" className="flex items-center hover:bg-bandiwala-orange hover:text-white">
